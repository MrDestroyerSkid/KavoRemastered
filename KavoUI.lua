...
local themes = {
    SchemeColor = tostring(Color3.fromRGB(74, 99, 135)),
    Background = tostring(Color3.fromRGB(36, 37, 43)),
    Header = tostring(Color3.fromRGB(28, 29, 34)),
    TextColor = tostring(Color3.fromRGB(255,255,255)),
    ElementColor = tostring(Color3.fromRGB(32, 32, 38))
}
local themeStyles = {
    DarkTheme = {
...
local Name = "KavoRemasterConfig.JSON"
...
function KavoRemaster.CreateLib(kavName, themeList)
    ...
    table.insert(KavoRemaster, kavName)
    ...
    KavoRemaster:DraggingEnabled(MainHeader, Main)
